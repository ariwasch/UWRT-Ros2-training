...
#include <ros-tut/srv/success.hpp>
#include <string>
...
class reset : public rclcpp::Node {
 ...
 private:
  rclcpp::Service<ros - tut::srv::Success>::SharedPtr service;
  rclcpp::TimerBase::SharedPtr timer;

  // all the turtles
  rclcpp::Client<turtlesim::srv::TeleportAbsolute>::SharedPtr client;
  // SOFTWARE_TRAINING_LOCAL //what is this?
  void reset_service(const std::shared_ptr<software_training::srv::Software::Request> request,
