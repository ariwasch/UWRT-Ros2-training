...
#include "ros_tut/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ros_tut::msg::Num *>(
    untyped_ros_message);
...
{
  return &ros_tut::msg::typesupport_fastrtps_cpp::_Num__handle;
}
