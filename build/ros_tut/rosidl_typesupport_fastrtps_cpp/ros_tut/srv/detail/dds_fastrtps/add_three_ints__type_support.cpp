...
#include "ros_tut/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ros_tut::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_tut::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  return &ros_tut::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const ros_tut::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros_tut::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros_tut::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
{
  return &ros_tut::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
