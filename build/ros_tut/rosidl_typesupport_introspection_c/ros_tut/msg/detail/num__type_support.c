...
#include <stddef.h>
#include "ros_tut/msg/detail/num__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Num__rosidl_typesupport_introspection_c__Num_message_member_array[1] = {
  {
    ...
    offsetof(ros_tut__msg__Num, num),  // bytes offset in struct
    NULL,  // default value
