...
bool ros_tut__msg__distance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_tut.msg._distance.Distance", full_classname_dest, 30) == 0);
  }
  ros_tut__msg__Distance * ros_message = _ros_message;
  {  // x_pos
...
PyObject * ros_tut__msg__distance__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_tut.msg._distance");
